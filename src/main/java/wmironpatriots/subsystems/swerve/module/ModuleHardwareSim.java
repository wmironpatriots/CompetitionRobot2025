...
public class ModuleHardwareSim extends ModuleHardware {
    ...
    public double getDriveDistanceMeters() {
        driveDistanceMeters = driveSim.getAngularPositionRad() * ModuleHardwareReal.WHEEL_RADIUS.in(Meters);
        return driveDistanceMeters;
    }

    @Override
    public double getDriveSpeedMps() {
        driveSpeedMps = driveSim.getAngularVelocityRadPerSec() * ModuleHardwareReal.WHEEL_RADIUS.in(Meters);
